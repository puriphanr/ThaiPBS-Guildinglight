...
<section id="banner" style="padding-bottom:0px;" class="hide">
	

	<div class="desktop-banner hidden-xs">
		<img src="<?php echo get_template_directory_uri();?>/images/banner_new.png" class="img-responsive" />
	</div>
	
		
</section>
<section id="schedule" style="margin-top:20px">
	<div class="container">
		<div class="col-lg-12 timetable">
			<div class="section-title"><img src="<?php echo get_template_directory_uri();?>/images/schedule_title_03.png" class="img-responsive" /></div>
			...
			<?php if( $schedule_query->have_posts() ): $i=1;?>
				<?php while( $schedule_query->have_posts() ) : $schedule_query->the_post(); ?>
					<div class="col-lg-2 col-md-12 col-xs-12 col-sm-12 <?php echo $i==1 ? 'col-lg-offset-1' : NULL ?> block">
							<div class="title col-lg-12 col-md-3 col-xs-3 col-sm-3"><?php the_title(); ?></div>
							<div class="thumbnail col-lg-12 col-md-3 col-xs-3 col-sm-3"><?php the_post_thumbnail(); ?></div>
...
<section id="meru">
	<div class="container">
		<div class="col-lg-12">
			<div class="section-title"><img src="<?php echo get_template_directory_uri();?>/images/meru_title_15.png" class="img-responsive" /></div>
				...
				<?php while( $video_query->have_posts() ) : $video_query->the_post(); ?>
					...
					<div class="col-lg-12">	
						<div class="videoWrapper">
							<iframe width="100%" src="<?php echo get_field('url')?>" frameborder="0" allowfullscreen></iframe>
						</div>
						<div class="media-title title-hilight">
									<div class="title"><?php the_title(); ?></div>
									<div class="date"><?php echo get_field('episode')?></div>
						</div>
					</div>
					<?php } else { ?>
					<article class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
